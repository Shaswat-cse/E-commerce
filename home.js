...
var clothsPart = document.getElementById("cloths");
var accessPart = document.getElementById("accessories");
for(var i = 0;i<homePageDetails.length;i++)
{
    if(!homePageDetails[i].isAccessory)
    {
        clothsPart.innerHTML += `<div id="cloths_accesories">
       <form id = "form1">
        <img onclick = detailsfunction(${i}) src="${homePageDetails[i].preview}">
     </form>
        <div id="cloth_access">
        <h3>${homePageDetails[i].name}</h3>
        <h5>${homePageDetails[i].brand}</h5>
        <p> Rs ${homePageDetails[i].price}</p>
        </div>
        ...
        accessPart.innerHTML += `<div id="cloths_accesories">
